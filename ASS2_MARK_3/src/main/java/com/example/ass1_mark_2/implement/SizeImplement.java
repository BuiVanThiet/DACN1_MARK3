...
import com.example.ass1_mark_2.respository.SizeRepository;
import com.example.ass1_mark_2.service.SizeService;
...
public class SizeImplement implements SizeService {
    ...
    public Page<Size> getPhanTrang(int page, int pageSize,String name){
        ...
        if(name.isEmpty() || name == null){
            return this.qls.findAll(pageable);
        }else {
            return this.qls.findByTenContainsIgnoreCase(name,pageable);
        }
    }
}
