...
public class BanHangController extends BaseController {
    ...
    private Integer pageNumBerHDByTTHT = 0;
...
//    public String getFormHoanThanh(ModelMap modelMap){
//        modelMap.addAttribute("listHDHT",qlhd.getHDByTTHT(pageNumBerHDByTTHT,2).getContent());
//        modelMap.addAttribute("form","../banHang/HoaDon.jsp");
//        return "homePage/Home";
//    }
