package com.example.ass1_mark_2.controller.base;
...
public abstract class BaseController {
    ...
    public String addAccout(ModelMap model){
        if(Account.getAccount().getSdt() != null){
            ...
            model.addAttribute("nameAccout", "Xin chào, " + Account.getAccount().getHoTen() + "chuc vu " + Account.getAccount().getChucVu());
